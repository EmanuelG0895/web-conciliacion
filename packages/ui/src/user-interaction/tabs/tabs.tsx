...
export default function DynamicTabs({ options }: DynamicTabsProps) {
  ...
  const activeContent = options.find(option => option.label === activeTab)?.content;
              ...
              className={`
                ...
                ${
                  activeTab === option.label
                    ? 'border-indigo-500 text-indigo-600' // Estilo Activo
