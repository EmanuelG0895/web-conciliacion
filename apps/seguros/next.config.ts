...
const PUBLIC_HOST = process.env.NODE_ENV === 'production'
    ? 'https://tu-dominio-principal.com' // Dominio real en producción
    : 'http://localhost:3000'; // Puerto del Router Principal en desarrollo
